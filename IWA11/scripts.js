...
const status1  = root1.getAttribute('data-delivered');
...
document.querySelector('.status').innerText = status1
...
const status2  = root2.getAttribute('data-delivered');
...
const status3 = document.querySelector('[data-key="order3"]').getAttribute('data-delivered');
...
document.querySelectorAll('.status')[2].innerText =status3   */
